...
### 16. `get_smart_minutes_address` — 获取智能纪要访问地址
...
**调用示例**：
```bash
mcporter call tencent-meeting-mcp get_smart_minutes_address --args '{"meeting_record_id": "xxx"}'
```
...
### 18. `export_asr_details` — 导出会议实时转写记录(已下线)
